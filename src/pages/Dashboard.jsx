      ...
      <main className="flex-1 md:ml-56 p-4 md:p-8 pb-24 md:pb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
          ...
          <div
            ...
            className="bg-gray-900 border border-gray-800 rounded-xl p-4 cursor-pointer hover:border-green-500/50 transition-all"
          >
            <p className="text-gray-500 text-xs font-mono uppercase tracking-widest mb-2">
              Revenue
            </p>
          ...
          {role === "admin" && (
            <div
              ...
              className="bg-gray-900 border border-gray-800 rounded-xl p-4 cursor-pointer hover:border-red-500/50 transition-all"
            >
              <p className="text-gray-500 text-xs font-mono uppercase tracking-widest mb-2">
                Expenses
              </p>
          ...
          {role === "admin" && (
            <div
              ...
              className="bg-gray-900 border border-gray-800 rounded-xl p-4 cursor-pointer hover:border-yellow-500/50 transition-all"
            >
              <p className="text-gray-500 text-xs font-mono uppercase tracking-widest mb-2">
                Net Profit
              </p>
              <p
                className={`text-2xl md:text-3xl font-black ${netProfit >= 0 ? "text-yellow-400" : "text-red-400"}`}
              >
                {pgConfig.currency}
            ...
            {rooms.length === 0 ? (
              ...
              <div className="grid grid-cols-5 gap-2">
                {rooms.map((room) => (
                  <div
                    key={room.id}
                    className={`border rounded-lg p-2 text-center cursor-pointer hover:scale-105 transition-all ${statusColors[room.status]}`}
                  >
            ...
            <div className="flex gap-3 mt-3 flex-wrap">
              {["occupied", "vacant", "maintenance", "reserved"].map((s) => (
                <div key={s} className="flex items-center gap-1">
                  <div
                    className={`w-2 h-2 rounded-full ${s === "occupied" ? "bg-indigo-400" : s === "vacant" ? "bg-green-400" : s === "maintenance" ? "bg-red-400" : "bg-yellow-400"}`}
                  ></div>
                  <span className="text-xs text-gray-600 font-mono capitalize">
                    {s}
                  </span>
                </div>
              ))}
